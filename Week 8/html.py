...
class Tag(object):
    ...
    tempVariable = property(get_temp, set_temp)

    @property
    def sampleString(self):
        print('getter is called')
        return self._sample

    @sampleString.setter
    def sampleString(self, val):
        print('setter is called')
        self._sample = val

    @sampleString.deleter
    def sampleString(self):
        print('you are not authorized to delete this attribute')
